...
- [x] Open S0: 0.
- [x] Open S1: 0.
- [x] A-30 is no longer evidence-deferred: supplied real iPad landscape evidence is reflected in the retained Detail width, vertical metadata and adaptive tag grid.
- [ ] Reference Alignment Pass: explicit Safari Cookie import, save-and-verify gate, visual hierarchy alignment, final immutable-head DEV sync and targeted iPad acceptance.
...
- [ ] Re-run targeted iPad acceptance only after the Account/Settings marker shows the final `release/1.0` head.
